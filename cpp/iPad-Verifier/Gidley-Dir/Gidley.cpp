...
Gidley::Gidley() : detected(false), missing(true) {}


void Gidley::detectRun() {
	...
	while(inputFile) {
		ifstream classFile("/Users/erik-argueta/Desktop/iPad-Verify/Files/master-lists/gidley-master-ipad-list.txt");
		inputFile >> inItem;
