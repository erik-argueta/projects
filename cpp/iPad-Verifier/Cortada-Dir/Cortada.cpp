...
Cortada::Cortada() : detected(false), missing(true) {}


void Cortada::detectRun() {
	...
	while(inputFile) {
		ifstream classFile("/Users/erik-argueta/Desktop/iPad-Verify/Files/master-lists/cortada-master-ipad-list.txt");
		inputFile >> inItem;
