...
Wilkerson::Wilkerson() : detected(false), missing(true) {}

void Wilkerson::detectRun() {
	...
	while(inputFile) {
		ifstream classFile("/Users/erik-argueta/Desktop/iPad-Verify/Files/master-lists/wilkerson-master-ipad-list.txt");
		inputFile >> inItem;
