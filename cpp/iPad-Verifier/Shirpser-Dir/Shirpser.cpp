...
Shirpser::Shirpser() : detected(false), missing(true) {}


void Shirpser::detectRun() {
	...
	while(inputFile) {
		ifstream classFile("/Users/erik-argueta/Desktop/iPad-Verify/Files/master-lists/shirpser-master-ipad-list.txt");
		inputFile >> inItem;
