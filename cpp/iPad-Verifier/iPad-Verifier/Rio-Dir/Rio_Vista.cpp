...
RioVista::RioVista() : detected(false), missing(true) {}


void RioVista::detectRun() {
	...
	while(inputFile) {
		ifstream classFile("/Users/erik-argueta/Desktop/iPad-Verify/Files/master-lists/rio-vista-master-ipad-list.txt");
		inputFile >> inItem;
