...
Potrero::Potrero() : detected(false), missing(true) {}


void Potrero::detectRun() {
	...
	while(inputFile) {
		ifstream classFile("/Users/erik-argueta/Desktop/iPad-Verify/Files/master-lists/potrero-master-ipad-list.txt");
		inputFile >> inItem;
