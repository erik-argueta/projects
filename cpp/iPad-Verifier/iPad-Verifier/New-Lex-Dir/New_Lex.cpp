...
NewLexington::NewLexington() : detected(false), missing(true) {}


void NewLexington::detectRun() {
	...
	while(inputFile) {
		ifstream classFile("/Users/erik-argueta/Desktop/iPad-Verify/Files/master-lists/new-lex-master-ipad-list.txt");
		inputFile >> inItem;
...
void NewLexington::trackMissing() {
